...
def test_run_hypothesis_no_false_warning_on_new(monkeypatch, caplog):
	...
	h = Hypothesis(strategy="A", data_sources=make_ds(db="test.db", series="SERIES_A"),
	               start_date="2025-01-01", end_date="2025-12-31")

	# Mock subprocess to return valid JSON
	fake_proc = MagicMock()
	fake_proc.stdout = '{"status":"ok","total_trades":100,"wins":60,"losses":40,"win_rate":0.6,"net_pnl_cents":500,"sharpe":1.5,"max_drawdown_pct":5.0,"total_fees_paid":100,"avg_win_cents":20,"avg_loss_cents":-10,"per_strategy":{},"pnl_values":[]}'  # noqa: E501
	fake_proc.stderr = ""
