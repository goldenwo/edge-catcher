...
def _make_request(
	*,
	...
	size: int = 10,
	limit: int = 5,
	strategy: str = "strat-34",
	client_order_id: str = "strat-34-KXSOL15M-1715195456789-abc12345",
	action: str = "buy",
) -> OrderRequest:
...
async def test_place_forwards_client_order_id_to_kalshi_request():
	...
	executor = LiveExecutor(client)  # type: ignore[arg-type]
	req = _make_request(client_order_id="strat-34-KXSOL15M-1715195456789-abc12345")
	...
	assert kalshi_req.client_order_id == "strat-34-KXSOL15M-1715195456789-abc12345"
