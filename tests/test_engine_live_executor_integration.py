...
def _engine_request(
	*,
	...
	client_order_id: str = "strat_34-KXSOL15M-26MAY09H06-1715195456789-abc12345",
	action: str = "buy",
) -> OrderRequest:
	return OrderRequest(
		ticker=ticker,
...
async def test_integration_happy_path_filled(
	...
	* OrderResult is filled with correct blended/fill_pct/slippage
	...
	assert body["client_order_id"] == "strat_34-KXSOL15M-26MAY09H06-1715195456789-abc12345"
...
async def test_integration_end_to_end_builder_to_executor(
	...
	assert body["client_order_id"].startswith("strat_34-KXSOL15M-26MAY09H06-")
