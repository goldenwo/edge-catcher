...
def _seed_pending(
	...
	*,
	coid: str = "debut-fade-KXSOL15M-1700000000000-cafebabe",
...
def _seed_open(
	conn: sqlite3.Connection,
	*,
	coid: str = "debut-fade-KXSOL15M-1700000000000-deadbeef",
	ticker: str = "KXSOL15M-26MAY16H12",
	side: str = "yes",
	intended_size: int = 10,
	fill_size: int = 10,
...
async def test_23_partial_exit_fill_splits_row(
	...
	await mock_kalshi_ws.emit_fill(
		client_order_id="debut-fade-KXSOL15M-1700000000777-exit0001",
...
async def test_23_fresh_kalshi_id_is_a_new_partial_not_a_dedup(
	...
	_wire(mock_kalshi_ws, conn, cbs)
	await mock_kalshi_ws.emit_fill(
		client_order_id="debut-fade-KXSOL15M-1700000000777-exitA",
	...
	await mock_kalshi_ws.emit_fill(
		client_order_id="debut-fade-KXSOL15M-1700000000888-exitB",
...
async def test_23_full_exit_fill_closes_in_place_with_fee_correct_pnl(
	...
	await mock_kalshi_ws.emit_fill(
		client_order_id="debut-fade-KXSOL15M-1700000000777-fullexit",
...
async def test_24_late_fill_after_settlement_is_lost_race_noop(
	...
	await mock_kalshi_ws.emit_fill(
		client_order_id="debut-fade-KXSOL15M-1700000000999-lateexit",
